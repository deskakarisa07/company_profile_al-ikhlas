...
<body>
    <div class="card login-card shadow-lg p-4 p-md-5">
        <div class="text-center mb-4"><img src="{{ asset('images/logo.png') }}" width="90" class="rounded-circle">
            <h3 class="mt-3">Login Administrator</h3>
            <p class="text-muted">Yayasan Al Ikhlas</p>
        </div>
        @if (session('success'))
        ...
        <form method="POST" action="{{ route('admin.login.submit') }}">@csrf
            ...
            <div class="mb-4"><label class="form-label">Password</label><input class="form-control" type="password"
