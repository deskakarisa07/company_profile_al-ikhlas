        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.profiles.update') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    @if ($profile->exists)
                        <div class="mb-2"><img src="{{ $profile->logo_url }}" alt="Logo {{ $profile->name }}"
                                style="width:80px;height:80px;object-fit:contain"></div>
                    @endif
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="email" name="email" value="{{ old('email', $profile->email) }}"
                        required>
                </div>
                <div class="col-12">
                    <label class="form-label">URL Embed Google Maps</label>
                    <input class="form-control" type="url" name="map_url"
